  ...
  offers: [
    {
      ...
      company: { name: "Fintech X" },
      salary_display_from: 350000,
      salary_display_to: 450000,
      salary_currency: "RUB",
      offer_description: "<p>Бэкенд на Python, ML-пайплайны</p>",
      location_items: [{ format: "remote" }],
      published_at: "2026-07-09",
      url: "/vacancies/1-senior-python",
    },
    {
      id: 2,
      position: "1C Консультант",
      company: { name: "Y" },
      salary_display_from: null,
      salary_display_to: null,
      salary_currency: null,
      offer_description: "<p>1C</p>",
      location_items: [],
      published_at: "2026-07-09",
      url: "/vacancies/2-1c",
    },
...
describe("getmatchSource", () => {
  ...
  it("fetchText читает из raw_json без сети", async () => {
    ...
    const card = (await src.search(["python"], {} as Config))[0]!;
    f.mockClear();
      ...
      offers: [
        {
          ...
          salary_display_to: null,
          salary_currency: null,
          offer_description: "<p>Python backend</p>",
          location_items: [],
          published_at: null,
          url: null,
        },
        {
          id: 2,
          position: "Python Broken",
          company: null,
          salary_display_from: null,
          salary_display_to: null,
          salary_currency: null,
          offer_description: "<p>Python broken record</p>",
          location_items: [],
          published_at: null,
          url: null,
        },
